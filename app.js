...
function goroSystemPrompt(word, morphemes) {
  ...
  return [
    ...
    "単なる説明文にはせず、思わずクスッと笑えるようなユーモアのある内容にしてください。意外な組み合わせ、ズッコケるようなオチ、大げさな展開などを積極的に取り入れてください。",
    "擬音語・擬態語（例: ドカン、ズキューン、ガタガタ、ワクワク、ニヤリ、ドキドキ など）も積極的に使い、コミカルで記憶に残りやすい一文にしてください。",
